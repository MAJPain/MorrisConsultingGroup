...
import {
  ...
  athSections,
  type AthInline,
} from "@/content/athletic-advising";

export const metadata: Metadata = {
  title: "Athletic Advising",
  description:
    "A specialized practice for organizations investing in the whole-person development of their student-athletes and families — post-athletic transition, navigating student-athlete life, and culture and respect coaching.",
};

function InlineNodes({ nodes }: { nodes: AthInline[] }) {
  return (
    <>
      {nodes.map((node, i) => {
...
export default function AthleticAdvisingPage() {
  return (
    <>
      <PageHeader
        eyebrow={athHeader.eyebrow}
        title={athHeader.title}
        subtitle={athHeader.subtitle}
        lede={athHeader.lede}
      />

      {athSections.map((section) => (
