...
export const team: TeamMember[] = [
  {
    ...
    initials: "SM",
    bio: [
      "Sheldon Morris is the founder and principal of Morris Consulting Group. He built the firm's advisory practice from client referrals beginning in 2017 and formalized it into the firm as it operates today.",
      "His twenty-two years as a U.S. Army officer included command of a training enterprise producing nine thousand five hundred soldiers annually, senior advisory to the senior military officer of a sovereign nation's defense enterprise during active operations, and Chief of Staff for the Army's institutional authority on leader development. His sixteen years in senior civilian executive and principal staff roles include chief operating officer, chief of staff, and senior advisor across the private, social, and banking sectors. Together, these positions gave him a direct view of how large organizations set direction and execute, and that perspective is the source of the counsel he brings to clients.",
